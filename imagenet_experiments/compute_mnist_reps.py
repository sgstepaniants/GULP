...
reps_folder = f"reps/mnist/{n}_{mode}"
...
transform = transforms.Compose([transforms.ToTensor(), transforms.Lambda(lambda x: x.repeat(3, 1, 1)), transforms.Resize(256), transforms.CenterCrop(224), normalize])
dataset = datasets.MNIST(root='../mnist_experiments/data/', train=True, transform=transform)
